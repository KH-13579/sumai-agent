...
class ChatResponse(BaseModel):
    ...
    maker_recommendation: Optional[List[MakerRecommendation]] = Field(None, description="推薦ハウスメーカー・ポータル")
    stage: Literal["hearing", "planning", "legal", "maker", "follow_up"] = Field(description="現在のフェーズ")
